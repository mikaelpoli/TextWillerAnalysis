...
TextWiller is made up of six core functions:  
...
and nine dictionaries:  

- Sentiment analysis:  

  * `vocabolariMadda`  
  * `vocabolarioMattivio` (emoticons' scores)  
  * `vocabolarioMattivio_ori (vocab_scores)` (emoticons' scores)  
  
- Text normalization:  

  * `vocabolarioEmote`
  * `vocabolarioEmoteSorted`  
  * `itastopwords`
